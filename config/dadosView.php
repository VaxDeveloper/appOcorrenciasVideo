 ...
 // Verifica se o ID da ocorrência foi passado na URL
                    if (isset($_GET['id'])) {
                        ...
                        if ($resultado_consulta && mysqli_num_rows($resultado_consulta) > 0) {
                            ...
                            echo "<a class='mt-1 mx-2 link-danger' href='../views/viewVideo.php?video1={$detalhes_ocorrencia['id']}'>Vídeo-1</a>";
                            echo "<a class='mt-1 mx-2 link-danger' href='../views/viewVideo.php?video2={$detalhes_ocorrencia['id']}'>Vídeo-2</a>";
                            echo "<a class='mt-1 mx-2 link-danger' href='../views/viewVideo.php?video3={$detalhes_ocorrencia['id']}'>Vídeo-3</a>";
                            echo "</div>";
                            echo "</div>";
                            ...
                            echo "<p for='acao' style='font-size: 1.0rem;'>1) Preencha os campos em aberto da ocorrência.</p>";
                            echo "<p for='acao' style='font-size: 1.0rem;'>2) Clique no botão 'ATRUALIZAR E FINALIZAR' para que os dados sejam registrados e finalizados.</p>";
                            echo "</div>";
                            echo "</div>";
