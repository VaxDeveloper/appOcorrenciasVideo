            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Visualizar Ocorrência</h3><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="../config/logout.php"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Fazer Logout</a>
                    </div>
                    <div class="card shadow">
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <?php include '../config/visualizarVideo.php'; ?>
                            </div>
                        </div>
                    </div>
                </div>
